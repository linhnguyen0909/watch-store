        ...
        <div class="row admin__content px-0">
            <div class=" col-sm-2 col-md-2 col-lg-2 col-xl-2 px-0">
                <div class="admin__manager">
                    ...
                    <ul class="px-0 nav-ul">
                        ...
                        <li><a href="${pageContext.request.contextPath}/quan-tri/nguoi-dung">Quản lí người dùng</a></li>
                        <li><a href="${pageContext.request.contextPath}/quan-tri/phan-quyen">Quản lí phân quyền</a></li>
            ...
            <div class="col-sm-10 col-md-10 col-lg-10 col-xl-10 admin__dashboard">
                ...
                <div class="row post__title">
                    ...
                    <a class="btn btn--black mt-2" href="${pageContext.request.contextPath}/quan-tri/danh-muc/chinh-sua">Thêm danh mục</a>
                ...
                <table class="table table-striped table__courses">
                    ...
                    <c:forEach var="order" items="${orders}">
                        <tr>
                            ...
                            <td>${ order.note }</td>
                            <td>
                                <a href="${pageContext.request.contextPath}/quan-tri/don-hang/chi-tiet?id=${order.id}"
									class="btn btn-info mr-2"> <i class="fas fa-edit"></i> </a>
                                 <a href="${pageContext.request.contextPath}/quan-tri/don-hang/${order.id}"
