									...
									<c:forEach var="productTop" items="${productTops}">
										<div class="product-item">
											<div class="product-item-img image-05">
												<a href="${pageContext.request.contextPath}/productdetail/${ productTop.id }"> <img
												...
												<div class="product-block-hover grid-hover">
													<div class="nm-cartmain add_to_cart_main grid-cart">
														<div class="product-form-item">
															<a 	href="/gio-hang/addProduct?id=${productTop.id}"
																id="addCart" class="nm-addToCart addToCart addCart enable btn"
				...
				<div class="contact-info">
					<div class="content-info- row">
						<div
							...
							<div class="content">
								<span class="text"> Gọi cho chúng tôi:</span> <a href="/"> +84
									3764616 </a>
							</div>
						</div>
						<div
