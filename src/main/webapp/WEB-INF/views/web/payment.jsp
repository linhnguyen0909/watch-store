        ...
        <div class="wrap-shipping">
            ...
            <div class="wrap-form">
                <form class="form-group w-25">
                    <p class="text_header">Phương thức thanh toán</p>
                    <div class="myRadio">
                        <label>
                    ...
                    <button class="btn btn-config btn-block btn-round"><a id="btnPayment" href="/check-pay/order-striple">Tiến hành thanh toán</button>
                    </formclass>
            </div>
        </div>
    </div>
