...
<script async defer crossorigin="anonymous"
	src="https://connect.facebook.net/vi_VN/sdk.js#xfbml=1&version=v10.0&appId=620736825090744&autoLogAppEvents=1"
	nonce="n7p0zFtV"></script>
</head>
						...
						<div class="col-xl-3 col-lg-3 col-md-12 col-sm-12 col-12">
							<div class="left-column product-category">
								<div class="sidebar-title">
									<a href="#">Watch</a>
									<div class="product-category-collapse">
										<i class="fas fa-chevron-down category "
											data-toggle="collapse" href="#acc"></i>
									</div>
								</div>
											...
											<div class="card-header" id="headingOne">
												<h2 class="mb-0">
													<button
														...
														Digital Watch <span class="fa-stack fa-sm"> <i
											...
											<div class="card-header" id="headingTwo">
												<h2 class="mb-0">
													<button
														...
														Quartz Watch <span class="fa-stack fa-sm"> <i
															class="fas fa-plus fa-stack-1x fa-inverse"></i>
														</span>
													</button>
												</h2>
											...
											<div class="card-header" id="headingThree">
												<h2 class="mb-0">
													<button
														...
														Undergraduate Studies <span class="fa-stack fa-sm">
							...
							<div class="left-column product-category">
								<div class="sidebar-title">
									<a href="#">FILTER</a>
									<div class="product-category-collapse">
										<i class="fas fa-chevron-down category collapsed"
											data-toggle="collapse" href="#category"></i>
									</div>
								</div>
								<div id="category" class="product-category-content">
									<div class="left-inner left-dropdown">
										<div class="filters-toolbar-input">
											<strong>COLOR </strong>
											<ul class="COLOR">
												<li><label class="custom-control material-checkbox">
														<input type="checkbox" class="material-control-input" />
														<span class="material-control-indicator"></span> <span
														class="material-control-description">Lee</span>
												</label></li>
												<li><label class="custom-control material-checkbox">
														<input type="checkbox" class="material-control-input" />
														<span class="material-control-indicator"></span> <span
														class="material-control-description">Puma</span>
												</label></li>
												<li><label class="custom-control material-checkbox">
														<input type="checkbox" class="material-control-input" />
														<span class="material-control-indicator"></span> <span
														class="material-control-description">Zara</span>
												</label></li>
											</ul>

											<strong>COLOR </strong>
											<ul class="color">
												<li><span class="custom-checkbox"> <a
														href="/collections/watch/color_black"> <span
															class="filter-color" style="background-color: black;"></span>
													</a>
												</span></li>

												<li><span class="custom-checkbox"> <a
														href="/collections/watch/color_blue"> <span
															class="filter-color" style="background-color: blue;"></span>
													</a>
												</span></li>

												<li><span class="custom-checkbox"> <a
														href="/collections/watch/color_green"> <span
															class="filter-color" style="background-color: green;"></span>
													</a>
												</span></li>

												<li><span class="custom-checkbox"> <a
														href="/collections/watch/color_purple"> <span
															class="filter-color" style="background-color: purple;"></span>
													</a>
												</span></li>

												<li><span class="custom-checkbox"> <a
														href="/collections/watch/color_white"> <span
															class="filter-color" style="background-color: white;"></span>
													</a>
												</span></li>
											</ul>
											...
											<ul class="goggles">
												<li><label class="custom-control material-checkbox">
														<input type="checkbox" class="material-control-input" />
														<span class="material-control-indicator"></span> <span
														class="material-control-description">Aviatorshape</span>
												</label></li>
											</ul>

											<strong>SIZE </strong>
											<ul class="size">
												<li><span class="custom-checkbox"> <a href="#">
											...
											<ul class="watch">
												<li><label class="custom-control material-checkbox">
														<input type="checkbox" class="material-control-input" />
														<span class="material-control-indicator"></span> <span
														class="material-control-description">Digitalwatch</span>
												</label></li>

												<li><label class="custom-control material-checkbox">
														<input type="checkbox" class="material-control-input" />
														<span class="material-control-indicator"></span> <span
														class="material-control-description">Quartzwatch</span>
												</label></li>

												<li><label class="custom-control material-checkbox">
														<input type="checkbox" class="material-control-input" />
														<span class="material-control-indicator"></span> <span
														class="material-control-description">Solarwatch</span>
												</label></li>
											</ul>
										</div>
									</div>
								...
								<div class="left-banner">
									<div class="left-banner-item">
										<div class="left-banner-image">
											<a class="customhover scale" href="#"> <img
												class="left-banner-img" src="images/Left-Banner.webp"
												alt="Left-banner" class="img-fluid" />
											</a>
										</div>
									</div>
								</div>
									...
									<div class="col-xl-6 col-lg-6 col-md-12 col-sm-12 col-12">
										<div class="product-detail">
											<div class="product-detail-zoom">
												<a class="item MagicZoom" href="images/product-1.webp">
													<img class="img-fluid"
													src="<spring:url value='/resources/assets/web/images/${productdetail.image}'/>"
													alt="product-1" class="img-fluid">
												</a> <a id="Zoom-detail" class="item MagicZoom"
													href="images/product-2.webp"> <img class="img-fluid"
													src="<spring:url value='/resources/assets/web/images/${productdetail.image}'/>"
													alt="product-2" class="img-fluid">
												</a>
										...
										<div class="product-detail-content ">
											...
											<div class="button-review">
												<span class="spr-badge"><span
													class="spr-starrating spr-badge-starrating"><i
														...
														class="spr-icon spr-icon-star-empty"></i><i
														class="spr-icon spr-icon-star-empty"></i><i
														class="spr-icon spr-icon-star-empty"></i></span> </span> <span
													class="no-review-yet">Đánh giá</span>
												<!--      <a href="#" class="write-comment">Write Review</a> -->
											</div>

											<div class="product-price">
												<span class="price-sale">${productdetail.price }</span> <span
													class="">VNĐ</span>
											</div>

											<p class="product-single">
												Product Type : <span>watch</span>
											</p>
											<div class="wishlist-chart">
												<div class="add-to-wishlist">
													<div class="show">
														<div class="added-wishbutton">
															<a class="added-wishlish" href="#"> <i
											...
											<div class="product-selection">
												<div class="product-count product-single">
													...
													<input name="quantity" value="${productdetail.quantity}"
														class="quantity">
													...
													<div class="nm-cartmain add_to_cart_main grid-cart">
														<div class="div">
															<div class="product-form-item">
																<a href="#"
																	class="nm-addToCart addToCart addCart enable btn"
																	...
																	data-image="${productdetail.image }"> > <span
								...
								<div class="product-tab">
									<ul class="nav nav-pills">
										<li class="nav-item"><a class="nav-link active"
											data-toggle="pill" href="#home">DESCRIPTION</a></li>
										<li class="nav-item"><a class="nav-link"
											data-toggle="pill" href="#menu1">REVIEWS</a></li>
										<li class="nav-item"><a class="nav-link"
											data-toggle="pill" href="#menu2">SHIPPING & RETURNS</a></li>
									...
									<div class="tab-content">
										<div class="tab-pane container active" id="home">
											...
											<ul>
												...
												<li>Pellentesque vitae neque mollis urna mattis
													laoreet.</li>
												<li>Divamus sit amet purus justo.</li>
												<li>Proin molestie egestas orci ac suscipit risus
													posuere loremou.</li>
											</ul>
											...
											<blockquote>
												<p>Faded short sleeves t-shirt with high neckline. Soft
													...
													material for a comfortable fit. Accessorize with a straw
													hat and you're ready for summe!</p>
											</blockquote>
										</div>
										<div class="tab-pane container fade" id="menu1">
											<div class="fb-comments"
												data-href="http://localhost:8082/productdetail/${productDetail.id}"
											...
											<div class="refund">
												...
												<div class="inner-content">
													...
													<p>You may return most new, unopened items within 30
														...
														error (you received an incorrect or defective item, etc.).</p>
													<p>You should expect to receive your refund within four
														...
														quickly. This time period includes the transit time for us
														to receive your return from the shipper (5 to 10 business
														days), the time it takes us to process your return once we
														receive it (3 to 5 business days), and the time it takes
														your bank to process our refund request (5 to 10 business
														days).</p>
													...
													<p>We can ship to virtually any address in the world.
														...
														destinations.</p>
													<p>When you place an order, we will estimate shipping
														and delivery dates for you based on the availability of
														your items and the shipping options you choose. Depending
														on the shipping provider you choose, shipping date
														estimates may appear on the shipping quotes page.</p>
													<p>Please also note that the shipping rates for many
								...
								<div class="back-to-watch">
									<div class="product-block-hover grid-hover">
										<div class="nm-cartmain add_to_cart_main grid-cart">
											<div class="div">
												<div class="product-form-item">
													<a href="#" class=" addToCart enable btn"> <i
														class="fas fa-long-arrow-alt-left"></i> <span
														class="value"> BACK TO WATCH </span>
													</a>
												</div>
											</div>
										</div>
								...
								<div class="product-banner">
									<div class="product-block container">
										<div class="section-header">
											<h3 class="home-title">RELATED PRODUCT</h3>
										</div>
													...
													<div class="tab-product ">
														<div class="product-item">
															<div class="product-item-img image-01">
																<a href="#"> <img src="images/product-3.webp"
																	alt="product-3" class="img-fluid" /> <img
																	src="images/product-2.webp" alt="product-2"
																...
																<div class="product-block-hover grid-hover">
																	<div class="nm-cartmain add_to_cart_main grid-cart">
																		<div class="div">
																			<div class="product-form-item">
																				<a href="#"
																					class="nm-addToCart addToCart enable btn"> <span
																					class="value"> Add To Cart </span>
																				</a>
																			</div>
																		</div>
														...
														<div class="product-item">
															<div class="product-item-img image-02">
																<a href="#"> <img src="images/product-5.webp"
																	alt="product-5" class="img-fluid" /> <img
																	src="images/product-4.webp" alt="product-4"
																	class="img-fluid extra-img" />
																</a>
																<div class="product-flag">
																	<span class="flag sale">SALE</span>
														...
														<div class="product-item">
															<div class="product-item-img image-03">
																<a href="#"> <img src="images/product-7.webp"
																	alt="product-7" class="img-fluid" /> <img
																	src="images/product-6.webp" alt="product-6"
																	class="img-fluid extra-img" />
																</a>
																<div class="product-flag">
																	<span class="flag sale">SALE</span>
														...
														<div class="product-item">
															<div class="product-item-img image-04">
																<a href="#"> <img src="images/product-9.webp"
																	alt="product-9" class="img-fluid" /> <img
																	src="images/product-8.webp" alt="product-8"
																	class="img-fluid extra-img" />
																</a>
																<div class="product-flag">
																	<span class="flag sale">SALE</span>
														...
														<div class="product-item">
															<div class="product-item-img image-05">
																<a href="#"> <img src="images/product-1.webp"
																	alt="product-1" class="img-fluid" /> <img
																	src="images/product-10.webp" alt="product-10"
																	class="img-fluid extra-img" />
																</a>
																<div class="product-flag">
																	<span class="flag sale">SALE</span>
