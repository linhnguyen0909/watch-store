        ...
        <div class="wrap-shipping">
            ...
            <div class="wrap-form">
                <Form class="form-group w-25">
                    ...
                    <c:if test="${sessionScope.user.fullname != null}">
                      <input class="form-control" type="text" placeholder="Họ và tên" name="name" value="${sessionScope.user.fullname }" />
                    </c:if>
                    ...
                    <div class="form-group">
                       <c:if test="${sessionScope.user.address != null}">
                        <input class="form-control" type="text" placeholder="Địa chỉ" name="address" value="${sessionScope.user.address}" />
</c:if>
                    </div>
                    <div class="form-group">
                          <c:if test="${sessionScope.user.email != null}">
                        <input class="form-control" type="text" placeholder="Email" name="email"value="${sessionScope.user.email }" />
</c:if>
                    </div>
                    <div class="form-group">
                        <c:if test="${sessionScope.user.email != null}">
                        <input class="form-control" type="text" placeholder="Số điện thoại" name="code" value="${sessionScope.user.phoneNumber }" />
</c:if>
                    </div>
               
                    <button class="btn btn-config btn-block btn-round"><a href="/check-pay/payment">Tiếp tục...</a></button>
                </Form>
            </div>
        </div>
    </div>
